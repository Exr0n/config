;;; fast-scroll-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Load some config defaults / binds." t nil)

(autoload 'fast-scroll-advice-scroll-functions "fast-scroll" "\
Wrap as many scrolling functions that we know of in this advice." t nil)
